...
<!-- container principal -->
	<div id="main" class="container">
	  ...
	  <div class="row">
		...
		<div class="form-group col-md-6">
		<label for="descricaoMat" >Descrição material: </label><br>
		<input type="text" class="form-control" name="descricaoMat" size="40" maxlength="45" placeholder="descrição material">
		</div>
	
		<div class="form-group col-md-6">
		<label for="nomeLivros" >Nomes dos livros utilizados: </label><br>
		<input type="text" class="form-control" name="nomeLivros" size="40" maxlength="45" placeholder="nome dos livros usados">
		</div>
